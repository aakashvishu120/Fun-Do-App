...
export class NotesIconComponent {
  ...
  @Input() context: 'form' | 'card' | 'trash' | 'archive' = 'form';
  @Input() noteId!: string;
  ...
  @Output() unarchived = new EventEmitter<void>();
  ...
  onUnarchiveClicked(){
    console.log("unachived event start");
    this.unarchived.emit();
    console.log("unachived event end");
  }
